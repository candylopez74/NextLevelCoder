import pygame
from dino_runner.utils.constants import DEFAULT_TYPE, DUCKING_SHIELD, JUMPING_SHIELD, RUNNING, RUNNING_SHIELD, DUCKING, JUMPING, SHIELD_TYPE
...
class Dinosaur(Sprite):
    ...
    def __init__(self):
        ...
        self.image = self.run_image[self.type][0]    #RUNNINIG [0] 
